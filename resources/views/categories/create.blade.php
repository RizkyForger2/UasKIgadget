...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-2xl font-bold mb-6 text-gray-800">
            <i class="fas fa-plus-circle text-blue-600"></i> Tambah Kategori Baru
        </h2>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" 
                           ...
                           placeholder="Contoh: Flagship" required>
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" name="icon" value="{{ old('icon') }}" 
                           ...
                           placeholder="Contoh: fa-crown">
                    <p class="text-sm text-gray-500 mt-1">
                        Lihat icon di: <a href="https://fontawesome.com/icons" target="_blank" class="text-blue-600">fontawesome.com/icons</a>
                    </p>
                </div>
